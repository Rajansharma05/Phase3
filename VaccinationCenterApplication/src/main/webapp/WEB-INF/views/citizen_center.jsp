        ...
        <div id="citizenEdit">
            ...
            <form id="citizenEditForm">
                ...
                <div class="form-group">
                    ...
                    <label class="form-control" id="vaccinationStatus" required></label>
                </div>
                <div class="form-group">
                ...
                <button type="submit" onclick="saveCitizen(event)" class="btn btn-primary">Submit</button><br>
...
<script>
    ...
    function redirectCallback() {
        let id = document.getElementById("centerId").value;
        window.location.href = getBaseUrl() + "/citizens/center/" + id;
    }
</script>
</html>
